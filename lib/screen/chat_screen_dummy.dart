...
class ChatScreenDummy extends StatefulWidget {
  const ChatScreenDummy({super.key});

  @override
  State<ChatScreenDummy> createState() => _ChatScreenDummyState();
}

class _ChatScreenDummyState extends State<ChatScreenDummy> {
